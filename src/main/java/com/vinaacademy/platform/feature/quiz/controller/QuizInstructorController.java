...
public class QuizInstructorController {
  ...
  @HasAnyRole({AuthConstants.ADMIN_ROLE, AuthConstants.INSTRUCTOR_ROLE})
  @PutMapping("/{id}")
  public ApiResponse<LessonDto> updateQuizLesson(
      @PathVariable UUID id, @RequestBody @Valid QuizCreateRequest request) {
    // Ensure the lesson type is set to QUIZ
    request.setType(LessonType.QUIZ);
  ...
  public ApiResponse<QuestionDto> createQuestion(
      @PathVariable UUID quizId, @RequestBody @Valid QuestionDto questionDto) {
  ...
  public ApiResponse<QuestionDto> updateQuestion(
      @PathVariable UUID questionId, @RequestBody @Valid QuestionDto questionDto) {
  ...
  public ApiResponse<AnswerDto> createAnswer(
      @PathVariable UUID questionId, @RequestBody @Valid AnswerDto answerDto) {
  ...
  public ApiResponse<AnswerDto> updateAnswer(
      @PathVariable UUID answerId, @RequestBody @Valid AnswerDto answerDto) {
  ...
  @HasAnyRole({AuthConstants.ADMIN_ROLE, AuthConstants.INSTRUCTOR_ROLE})
  @GetMapping("/{quizId}/student-attempts")
  public ApiResponse<List<QuizStudentAttemptsDto>> getStudentAttempts(@PathVariable UUID quizId) {
    List<QuizStudentAttemptsDto> attemptsDto = quizService.getStudentAttempts(quizId);
    return ApiResponse.success(attemptsDto);
  }
}
