...
public class FavoriteController {
	...
	public ApiResponse<String> deleteFavorite(@PathVariable String commentId) {
		FavoriteRequest favoriteRequest = FavoriteRequest.builder()
				.commentId(UUID.fromString(commentId))
				.build();
		favoriteService.deleteFavorite(favoriteRequest);
		return ApiResponse.success("Xóa thành công lượt thích với id comment " + commentId);
	}
}
